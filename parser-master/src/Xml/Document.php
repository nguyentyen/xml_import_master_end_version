...
//require_once('parser-master\src\Document.php');
//require_once('parser-master\src\Xml\Concerns\SupportMultiLevel.php');
require_once DIRECTORY_SEPARATOR.'home'.DIRECTORY_SEPARATOR.'probearbeit'.DIRECTORY_SEPARATOR.'parser-master'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'Document.php';
require_once DIRECTORY_SEPARATOR.'home'.DIRECTORY_SEPARATOR.'probearbeit'.DIRECTORY_SEPARATOR.'parser-master'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'Xml'.DIRECTORY_SEPARATOR.'Concerns'.DIRECTORY_SEPARATOR.'SupportMultiLevel.php';
